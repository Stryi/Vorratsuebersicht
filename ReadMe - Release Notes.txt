...
C223 - API-Level auf 34 gesetzt (Google Anforderung)
C222 - Die rote Kugel mit Zahl im Lagerbestand Button jetzt auch auf der rechten Seite.

Version 8.20 (Code Version 147)
=====================================

E070 - Auswahl Lager berücksichtigt jetzt auch Standardlager im Artikelstamm.
C221 - Neuer Menüeintrag im Lagerbestand zum Löschen vom gesamten Lagerbestand.
...
E046 - Artikelname und Notizen jetzt wieder mehrzeilig möglich.
...
C166 - ENTFERNT (Quellcode unsicher): Verzeichnisse in den Einstellungen können jetzt komfortabel ausgewählt werden.
