...
%adbCmd% -s %EmulatorName%   shell rm    %SD_Card_Path%/Vorratsuebersicht/*.*
...
REM %adbCmd% -s %EmulatorName%   push ..\Assets\Vorraete_db0.db3   %App_Path%/Vorraete_db0.db3
REM %adbCmd% -s %EmulatorName%   push ..\Assets\Vorraete_Demo.db3  %App_Path%/Vorraete_Test.db3
